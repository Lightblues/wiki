...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16087230546557.jpg)
...
* 格式说明符
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16087234265571.jpg)
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16087238216033.jpg)
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16087252956536.jpg)
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16090356051025.jpg)
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16090379558633.jpg)
...
* 字典定义
    ...
    * 4 支持字典推导式生成字典
    ![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16090762594110.jpg)

![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16090762938863.jpg)
...
* 字典元素的添加与修改：setdefault
    ...
    * `setdefault(key[,default])`, 返回d[key]或者default，但是如果key不在字典，会添加key:default【用来查询 key 返回对应的 value，若 key 不再字典中则会在字典中添加该记录，而不是像 get(key[, default]) 一样返回指定的默认值（默认为 None）】
    ![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16090780982856.jpg)
* 删除元素
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16090797540028.jpg)
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16090798648334.jpg)
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16090824106434.jpg)

### 字符串类型判断： 根据Unicode字符集中的类型判断

![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16090827528574.jpg)
...
* unicode字符串str与字节串bytes之间的转换
    ...
    * errors参数指出在编码/解码过程中无法转换时怎么办？缺省‘strict’，即 比如某些字符不属于相应字符集中的字符，或者某些字节不是合法的字节序列
    ![-w402](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091292039635.jpg)
    ![-w909](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091292718104.jpg)
...
* 打开文件
    ...
    * 访问模式(mode)：第2个参数，打开文件后的处理方式
        ...
        * 如果不指定mode，默认为‘r’，即打开文本文件读
        ![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091333143775.jpg)
...
* 文件对象的属性
    ...
    * closed 是否_已经关闭
* 文件对象的操作
    ![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091335952821.jpg)
* 文本文件读： read
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091368085806.jpg)
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091381782490.jpg)
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091387408303.jpg)
* 常用异常类
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091423869167.jpg)
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091432750244.jpg)
* 什么时候需要使用多行匹配模式？
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091436732720.jpg)

#### search

* `match = regexp.search(text)`
* 在字符串string或其指定范围string[pos:endpos)搜索第一个与模式匹配的内容。若找到，返回一个描述匹配信息的Match对象，否则返回 None
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091442591864.jpg)
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091452147197.jpg)
...
* 具有特殊含义的元字符包括 `. ^ $ * + ? { } [ ] \ | ( )`
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091453853914.jpg)
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091473928674.jpg)
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091499702206.jpg)

### 正则表达式元字符-边界匹配符

* 0宽度边界匹配符：字符串匹配往往涉及从某个位置开始匹配，例如行的开头结尾、单词边界等，边界匹配符用于匹配字符串的位置，不会消耗模式中的字符

![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091502617049.jpg)
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091503717829.jpg)
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091504628480.jpg)
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091517544151.jpg)
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091526454085.jpg)
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16087276625102.jpg)

### random

![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16087276753956.jpg)
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16091327029724.jpg)

### time

![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16090386184186.jpg)
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16090387250946.jpg)

### datetime

![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16090389379048.jpg)
...
![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16090777817544.jpg)
...
* 相较于 tuple
    ![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Python-note/16090793142436.jpg)
