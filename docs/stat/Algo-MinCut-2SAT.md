...
![image-20220304135630565](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Algo-MinCut-2SAT/image-20220304135630565.png)
...
![image-20220304140102490](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Algo-MinCut-2SAT/image-20220304140102490.png)

- Random Contraction Algorithm

每次都随机 contract 一条边, 直到只剩下两个节点 (每次点数-1, 因此会迭代 n-2 次).

![image-20220304140425665](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Algo-MinCut-2SAT/image-20220304140425665.png)

- Karger–Stein Algorithm

![image-20220304143001691](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Algo-MinCut-2SAT/image-20220304143001691.png)
...
![image-20220304134922649](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Algo-MinCut-2SAT/image-20220304134922649.png)
...
![image-20220304154648137](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Algo-MinCut-2SAT/image-20220304154648137.png)
...
![image-20220304155612064](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Algo-MinCut-2SAT/image-20220304155612064.png)
