...
- 比较: 在 X 正交的情况, 三者都有显式解.
    - ![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/ASL-mindmap/2022-04-04-22-13-57.png)
...
- Local Polynomial Regression 局部多项式回归
    ...
    - ![](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/ASL-mindmap/2022-04-04-22-14-34.png)
