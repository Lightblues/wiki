...
- 图灵机 (无限的纸带, 可读写); 因此是算法;
    ...
    - ![image-20220608223940807](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Algo-computation-计算理论/image-20220608223940807.png)
...
- 递归语言
    ...
    - ![image-20220609162639346](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Algo-computation-计算理论/image-20220609162639346.png)
    ...
    - **Undecidable Problems** (unsolvable problems)
        ...
        - 著名的停机问题: 我们无法判断一个图灵机对于某一输入是否可以停机 (还是陷入死循环).
            ...
            - ![image-20220609170837599](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Algo-computation-计算理论/image-20220609170837599.png)
        - 类似的成员问题: 无法判断图灵机是否接受一个输入.
            - 证明思路是类似的: 反证法, 加入有这样的一个机器, 我们可以利用它来避免死循环, 从而出现 `decidable = acceptable` 的悖论.
            - ![image-20220609171535110](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Algo-computation-计算理论/image-20220609171535110.png)
- 时间复杂度
    ...
    - NP-complete Languages
        ...
        - 给出一个多项时间内归约的例子: 将 `3CNF-satisfiability` 问题转化为 `CLIQUE` problem.
            ...
            - ![image-20220609224409329](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Algo-computation-计算理论/image-20220609224409329.png)
        ...
        - 理解三类的关系
            - ![image-20220609224837178](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Algo-computation-计算理论/image-20220609224837178.png)
    - 给出一个NPC的例子: SAT问题
        - 注意下面就给了思路, 具体的证明是 [Cook Levin theo](https://en.wikipedia.org/wiki/Cook%E2%80%93Levin_theorem).
        - ![image-20220609225218237](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Algo-computation-计算理论/image-20220609225218237.png)
        - ![image-20220609225238403](https://cdn.jsdelivr.net/gh/lightblues/assets@main/wiki/Algo-computation-计算理论/image-20220609225238403.png)
